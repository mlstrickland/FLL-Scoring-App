...
//this function uses the "matchrelation" table to determine which global match number corresponds to each teams performance on the table 
//for instance: Match 5 is the second play for team X
//this exists because it is not possible to determine what column a specific entry in a row is in is you only have the value
//the "matchrelation table" currently must be updated manually though at some point will be changes so that updates to the "match" table are reflected in it
